...
batchsz=50
validation_ds=ValidationSpectrogram(labeltxt='E:\ALOSPALSAR\ValidationData\ALPSRP205991510test\spe4bands24.txt', transform=data_transforms)
validation_ds.__init__(labeltxt='E:\ALOSPALSAR\ValidationData\ALPSRP205991510test\spe4bands24.txt', transform=data_transforms)
...
model = torch.load('models\models1test0616.pkl')
model.eval()
